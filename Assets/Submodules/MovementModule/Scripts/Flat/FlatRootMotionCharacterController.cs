...
public class FlatRootMotionCharacterController : BaseRigidbodyCharacterController {
	[SerializeField]
    ...
    public override void Idle() {
		...
		// flatRigidbody.ThisRigidbody.MovePosition(flatRigidbody.ThisRigidbody.position + animatorIKValuesSetter.DeltaPosition);
